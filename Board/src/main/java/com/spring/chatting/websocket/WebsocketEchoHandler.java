...
public class WebsocketEchoHandler extends TextWebSocketHandler {
		// TextWebSocketHandler를 상속받아와서 메소드를 재정의함
	    ...
	    */
	    ...
	    public void afterConnectionEstablished(WebSocketSession wsession) 
	    	...
	    	connectedUsers.add(wsession);	// wssession에 접속한 유저들을 쌓아둠
        ...
        */
	    ...
	    protected void handleTextMessage(WebSocketSession wsession, TextMessage message) 
	    	...
	    	/*
		    	...
		    	websocket:handlers 태그 안에 있는  websocket:handshake-interceptors에
            ...
            */
	        ...
	        for (WebSocketSession webSocketSession : connectedUsers) {
	            if (messageVO.getType().equals("all")) { // 채팅할 대상이 "전체" 일 경우 
	                ...
	                }							// >> 접속한 유저 자신의 ip									/ + 로그인 유저의 이름  / + vo객체화 한 메시지 내용
        ...
        */
	    ...
	    public void afterConnectionClosed(WebSocketSession wsession, CloseStatus status) 
	    	...
	    	connectedUsers.remove(wsession); // 채팅방 유저 목록에서 나간 유저 삭제
	    ...
	    // 실행시 딱 1번 실행할 내용이 필요한 경우 안에 내용물 채우기
